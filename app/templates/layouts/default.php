          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <div class="dropdown-divider"></div>
                ...
                <a class="dropdown-item" href="/show?id=4">Принтеры</a>
                <a class="dropdown-item" href="#">Комплектующие</a>
              <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="">Мебель</a>
              <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="/show?id=5">Столы/Стулья</a>
                <a class="dropdown-item" href="/show?id=8">Диваны/Кресла</a>
                <a class="dropdown-item" href="/show?id=7">Шкафы</a>
              <div class="dropdown-divider"></div>
